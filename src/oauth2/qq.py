...
"""
Oauth2.0 Client SDK 用于 QQ 登录及openapi调用，（非官方）sdk
原始网址：https://code.google.com/p/connect-python-sdk-oauth2-for-qq/
__origin_author__ =  'Su Wei (objcc1@gmail.com)'
__version__=  '0.1'
"""

# The `simplejson`, which is the default JSON lib in Django project, is faster than standard library `json`
...
class OauthVars:
    ...
    def __init__(self):
        ...
        """
        self.Oauth_appid='100338382'					    # APP ID
        self.Oauth_appkey='802a92175026c82c6e18dc67da0bf624'# KEY
        self.Oauth_callback='www.baostar.com/home/qq/login/done/' # 回调地址
        ...
        # openapi_url
        # fixed bug: self.Oauth_appkey => self.Oauth_appid；此处oauth_consumer_key对应YOUR_APP_ID
...
class OauthClient(object):
    ...
    def request_openapi(cls, api_path_str, query_str='', post_str=None):
        ...
        openapi_url = cls.openapi_url.replace('<api>',api_path_str).replace('<query_str>',query_str)[:-1]
